 ...
 * Generic function preserves extended types (e.g., ConfessionWithProfile)
 */
export function sortByFeatured<T extends Confession>(confessions: T[]): T[] {
 ...
 * Generic function preserves extended types (e.g., ConfessionWithProfile)
 */
export function sortByLatest<T extends Confession>(confessions: T[]): T[] {
    return [...confessions].sort((a, b) => {
